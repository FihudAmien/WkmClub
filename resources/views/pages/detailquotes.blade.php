...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">Detail Quotes</li>
        </ol>
    </nav>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-xl-8 offset-lg-1 offset-xl-2">
                    <div class="intro">
                        <h1 class="text-center">{{ $item->titlequotes }}<br></h1>
                        ...
                        <img class="img-fluid" src="{{asset('frontend/img/' . $item->thumbnailsquotes)}}">
                    </div>
                    <div class="text">
                        {!! $item->contentquotes !!}
                    </div>
